...
#include <jni.h>
#include "src/org_qw3rtrun_libretro_EnvironmentNative.h"
...
BOOST_AUTO_TEST_CASE(CheckRetroStub) {
    ...
    jclass envClass = env->FindClass("org/qw3rtrun/libretro/EnvironmentNative");
    BOOST_CHECK_NE(envClass, nullptr);

    static JNINativeMethod methods[] = {
            {"getVariable",    "(Ljava/lang/String;)Lorg/qw3rtrun/libretro/Variable;",  (void *)&Java_org_qw3rtrun_libretro_EnvironmentNative_getVariable}
    };
    ...
    jmethodID getVarMethod = env->GetMethodID(envClass, "getVariable", "(Ljava/lang/String;)Lorg/qw3rtrun/libretro/Variable;");
    ...
    jclass varClass = env->FindClass("org/qw3rtrun/libretro/Variable");
